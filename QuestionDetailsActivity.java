...
import static com.example.quizapp.QuestionsAdminActivity.quesList;
...
public class QuestionDetailsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        {
            qID = getIntent().getIntExtra("QUESTION" + String.valueOf(1),0);
            loadData(qID);
    ...
    private void addNewQuestion()
    {
        ...
        Map<String,Object> quesData = new androidx.collection.ArrayMap<>();
        ...
        firestore.collection("Quiz").document(catList.get(selected_cat_index).getId())
                ...
                .addOnSuccessListener(new OnSuccessListener<Void>() {
                    ...
                    public void onSuccess(Void aVoid) {
                        ...
                        quesDoc.put("QUESTION" + String.valueOf(quesList.size() + 1) + "_ID", doc_id);
