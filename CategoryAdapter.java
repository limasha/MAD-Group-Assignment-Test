...
public class CategoryAdapter extends RecyclerView.Adapter<CategoryAdapter.ViewHolder> {
    private List<CategoryAdminModel> cat_list;

    public CategoryAdapter(List<CategoryAdminModel> cat_list) {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        private void setData(String title, final int pos, final CategoryAdapter adapter)
        {
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    CategoryAdminActivity.selected_cat_index = pos;
                    Intent intent = new Intent(itemView.getContext(),SetAdminActivity.class);
        ...
        private void deleteCategory(final int id, final Context context, final CategoryAdapter adapter)
        {
            ...
            for(int i=0; i < cat_list.size(); i++)
            {
                if( i != id)
                {
                    catDoc.put("CAT" + String.valueOf(index) , cat_list.get(i).getId());
                    catDoc.put("CAT" + String.valueOf(index) , cat_list.get(i).getName());
                    index++;
                }
            ...
            firestore.collection("Quiz").document("Categories")
                    ...
                    .addOnSuccessListener(new OnSuccessListener<Void>() {
                        ...
                        public void onSuccess(Void aVoid) {
                            ...
                            CategoryAdminActivity.catList.remove(id);
            ...
            firestore.collection("Quiz").document(cat_list.get(pos).getId())
                    ...
                    .addOnSuccessListener(new OnSuccessListener<Void>() {
                        ...
                        public void onSuccess(Void aVoid) {
                            ...
                            Map<String,Object> catDoc = new ArrayMap<>();
                            catDoc.put("CAT" + String.valueOf(pos + 1) ,catNewName);
                            ...
                            firestore.collection("Quiz").document("Categories")
                                    ...
                                    .addOnSuccessListener(new OnSuccessListener<Void>() {
                                        ...
                                        public void onSuccess(Void aVoid) {
                                            ...
                                            CategoryAdminActivity.catList.get(pos).setName(catNewName);
                                            adapter.notifyDataSetChanged();
